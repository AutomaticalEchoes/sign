...
import automaticalechoes.simplesign.client.ClientSign;
...
public class FabricClientGetMarkCommand {
    public static final LiteralArgumentBuilder<FabricClientCommandSource> SSI =
            ClientCommandManager.literal("ssi_client").requires(commandSourceStack -> commandSourceStack.hasPermission(0));

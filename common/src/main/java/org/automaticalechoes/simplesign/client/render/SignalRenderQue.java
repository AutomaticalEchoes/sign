...
import org.automaticalechoes.simplesign.client.ILevelRender;
...
public class SignalRenderQue extends LinkedList<ClientSign> {
    ...
    public static final ResourceLocation VIEW_FACE =  ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID,"textures/view_face.png");

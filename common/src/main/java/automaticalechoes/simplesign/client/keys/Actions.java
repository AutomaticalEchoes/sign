...
import automaticalechoes.simplesign.client.Utils;
...
public class Actions {
    ...
    public static void RemoveMark(){
        if(!SimpleSign.Client.MARK_RENDER.isEmpty()){
            SimpleSign.Client.MARK_RENDER.remove(SimpleSign.Client.MARK_RENDER.size() - 1);
        }
    }

    public static void ClearMark(){
        SimpleSign.Client.MARK_RENDER.clear();
    }

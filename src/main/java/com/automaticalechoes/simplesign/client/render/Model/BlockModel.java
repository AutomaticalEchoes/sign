package com.automaticalechoes.simplesign.client.render.Model;
...
public class BlockModel extends Model {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SimpleSign.MODID, "sign_block"), "main");
    private final ModelPart bone;

    public BlockModel(ModelPart root) {
        super(RenderType::outline);

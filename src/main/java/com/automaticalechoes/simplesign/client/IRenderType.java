...
public class IRenderType extends RenderType {
    private static final Function<ResourceLocation, RenderType> ITEM_ENTITY_TRANSLUCENT_CULL_SEE_T = Util.memoize((p_286155_) -> {
        CompositeState rendertype$compositestate = CompositeState.builder().setShaderState(RENDERTYPE_ITEM_ENTITY_TRANSLUCENT_CULL_SHADER)
    ...
    private static final Function<ResourceLocation, RenderType> ENTITY_TRANSLUCENT_CULL_SEE_T = Util.memoize((p_286165_) -> {
        CompositeState rendertype$compositestate = CompositeState.builder().setShaderState(RENDERTYPE_ENTITY_TRANSLUCENT_CULL_SHADER)
    ...
    private static final Function<ResourceLocation, RenderType> ENTITY_CUTOUT_SEE_T = Util.memoize((p_286173_) -> {
        CompositeState rendertype$compositestate = CompositeState.builder().setShaderState(RENDERTYPE_ENTITY_CUTOUT_SHADER).setTextureState(new TextureStateShard(p_286173_, false, false))

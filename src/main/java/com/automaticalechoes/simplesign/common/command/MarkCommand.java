...
public class MarkCommand {
   ...
   public static ResourceKey<ChatType> SIGN = null;
...
//                       .withStyle(ChatFormatting.GREEN))
       ...
       sourceStack.getServer().getPlayerList()
               .broadcastChatMessage(PlayerChatMessage.unsigned(MessageSigner.create(sourceStack.getPlayer().getUUID()),new ChatMessageContent("",mutableComponent)),sourceStack.getPlayer(), bind);

...
public class EntitySign implements Sign {
    ...
    public EntitySign(UUID uuid, BlockPos pos,ItemStack itemStack){
        this.uuid = uuid;
        this.pos = pos;
    ...
    public Vec3 getPointPos() {
        return entity != null ? entity.getEyePosition() : Vec3.atCenterOf(pos);
    }
    ...
    public Boolean CanUse() {
        if(Minecraft.getInstance().player.position().subtract(Vec3.atCenterOf(pos)).length() < 32.0D
